...
def run_test_count_cosines_from():
    ...
    expected = 3
    answer = count_cosines_from(2, 13, 0.5)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    expected = 5
    answer = count_cosines_from(24, 34, 0.3)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    expected = 1
    answer = count_cosines_from(45, 55, 0.75)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    expected = 1
    answer = count_cosines_from(60, 69, 0.8)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    expected = 2
    answer = count_cosines_from(6, 11, 0.1)
...
def run_test_sum_unit_fractions_from():
    ...
    expected = 0.24  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(8, 9)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    expected = 0.25  # This is APPROXIMATELY the correct answer.
